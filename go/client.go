// Package uuidgenerator provides a Go client for the UUID Generator API.
//
// For more information, visit: https://apiverve.com/marketplace/uuidgenerator?utm_source=go&utm_medium=readme
...
const (
	baseURL        = "https://api.apiverve.com/v1/uuidgenerator"
	defaultTimeout = 30 * time.Second
)

// Client is the UUID Generator API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new UUID Generator API client.
...
// Execute makes a request to the UUID Generator API with typed parameters.
//
...
//   - count: integer - Number of UUIDs to generate [min: 1, max: 100]
//   - version: integer - UUID version (only version 4 currently supported)
