...
// Request contains the parameters for the UUID Generator API.
//
// Parameters:
...
type Request struct {
	...
	Version int `json:"version,omitempty"` // Optional
...
// ResponseData contains the data returned by the UUID Generator API.
