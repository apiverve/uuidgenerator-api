...
```gradle
dependencies {
    implementation 'com.github.apiverve:uuidgenerator-api:1.1.12'
}
```
...
```java
import com.apiverve.uuidgenerator.UUIDGeneratorAPIClient;
import com.apiverve.uuidgenerator.APIResponse;
import com.apiverve.uuidgenerator.APIException;

// Initialize the client
UUIDGeneratorAPIClient client = new UUIDGeneratorAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/uuidgenerator](https://docs.apiverve.com/ref/uuidgenerator)
...
- **Documentation:** [https://docs.apiverve.com/ref/uuidgenerator](https://docs.apiverve.com/ref/uuidgenerator)
- **Issues:** [GitHub Issues](https://github.com/apiverve/uuidgenerator-api/issues)
