...
class uuidgeneratorWrapper {
    ...
    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/uuidgenerator');
        }
        ...
        this.baseURL = 'https://api.apiverve.com/v1/uuidgenerator';

        // Validation rules for parameters (generated from schema)
        this.validationRules = {"count":{"type":"integer","required":false,"min":1,"max":100,"default":1},"version":{"type":"integer","required":false,"default":4},"format":{"type":"string","required":false,"default":"default"}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/uuidgenerator`);
        }
    }
...
module.exports = uuidgeneratorWrapper;
