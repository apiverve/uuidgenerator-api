...
{
    class UUIDGeneratorExample
    {
        private static readonly string API_KEY = Environment.GetEnvironmentVariable("APIVERVE_API_KEY") ?? "YOUR_API_KEY_HERE";
        private static readonly string API_URL = "https://api.apiverve.com/v1/uuidgenerator";

        /// <summary>
        /// Make a GET request to the UUID Generator API
        /// </summary>
        static async Task<JsonDocument> CallUUIDGeneratorAPI()
        {
            try
            {
                ...
                // Query parameters
                var queryParams &#x3D; new Dictionary&lt;string, string&gt; { [&quot;count&quot;] &#x3D; &quot;5&quot;, [&quot;version&quot;] &#x3D; &quot;4&quot;, [&quot;format&quot;] &#x3D; &quot;default&quot; };
        ...
        {
            Console.WriteLine("📤 Calling UUID Generator API...\n");

            var result = await CallUUIDGeneratorAPI();
